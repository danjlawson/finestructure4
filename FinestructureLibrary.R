...
expandDendrogramLabels<-function(tdend){ ## takes each label and applies a name expansion to it. Then applies a contraction to simplify the names once again
    dendrapply(tdend,function(x){
...
uniqueCutHeights<-function(tdend){ ## Useful for getting "all K" for cutting of a tree
